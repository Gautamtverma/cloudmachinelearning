...
def compare_label():
    ...
    with open('Google_Image_Analysis.csv', 'r') as csv_file:
    ...
    with open('GroundTruth.csv', 'r') as gt_csv:
        ...
        for lines in csv_reader1:
            gtData.append(lines)
            # print lines
    #creating a aws complete image analysis file along with the field names
    with open('Google_Complete_image_analysis.csv', 'w') as csvfile:
