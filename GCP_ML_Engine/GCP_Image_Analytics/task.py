...
def load_data(path):
    bio = BytesIO(file_io.read_file_to_string(path, binary_mode=True))
	TrainData = sio.loadmat(bio)
...
def train_images(path):
    ...
    with tf.Session() as sess:
        ...
        for i in range(epochs):
            ...
            if i %5 ==0:
                saver.save(sess, "ckpt/CNN_MC_" + str(i) +".ckpt")
...
if __name__ == '__main__':
    ...
    train_images(args.user_first_arg)